...
const Employees = () => {
  return (
    <div class="flex mt-[52px]" id="services">
      <div class="w-1/2 w-[960px] h-[428px] bg-gray-100 flex justify-center items-center gap-9">
        {/* Card 1 */}
      ...
      <div class="w-1/2 w-[960px] h-[428px] bg-blue-500 flex justify-center items-center font-normal">
